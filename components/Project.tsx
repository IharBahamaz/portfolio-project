...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
  ...
  return (
    ...
    >
      <section
        className="rounded-lg bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative
        sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 
        hover:bg-gray-200 transition group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white
    "
      >
